<div align="center">
  ...
  <p>一个面向推荐系统与计算广告的知识库:判别式推荐、生成式推荐、计算广告专题,为人类读者与 AI agent 的 auto research 提供结构化、可精确引用的技术知识。</p>

  <p><a href="https://haozhe-xing.github.io/fun-rec-mdbook/"><strong>📖 在线阅读</strong></a> · <a href="https://github.com/Haozhe-Xing/fun-rec-mdbook">GitHub 仓库</a></p>
</div>
