...
> 📝 **Before You Continue:** 请先读完 [1.1](./../part1-introduction/what-is-recommender.md) 的「两种根本范式」与 [2.x](./../part2-retrieval/) 的判别式召回/排序。本章把「判别式」与「生成式」的对照从直觉推进到建模哲学与架构层面，是后续所有生成式章节的理论起点。
