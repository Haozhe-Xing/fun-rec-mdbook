...
本书共 **11 个 Part**，建议按顺序阅读；如果你已有推荐系统基础，也可以直接跳到感兴趣的主题。
...
默认会在本地启动一个预览服务。打开终端输出中的地址，即可阅读本书。
...
├── book.toml                 # mdBook 配置
├── GLOSSARY.md               # 术语表
├── part1-introduction/       # 推荐系统全景
├── part2-retrieval/          # 召回
├── part3-ranking/            # 排序
├── part4-rerank/             # 重排
├── part5-trends/             # 前沿趋势
├── part6-gr-basic/           # 生成式推荐基础
├── part7-scaling/            # 生成式排序 Scaling
├── part8-e2e/                # 端到端生成式应用
├── part9-thinking/           # 推荐中的思考与推理
├── part10-diffusion/         # 扩散模型推荐
├── part11-project/           # 生成式推荐系统实战
├── appendix/                 # 附录
├── images/                   # SVG 图表资源
├── viz/                      # 交互式可视化资源
├── styles/                   # 自定义样式
