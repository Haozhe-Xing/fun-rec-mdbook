...
> 📝 **Before You Continue:** 请先读完 [1.1](./../part1-introduction/recommender-system-basics.md) 的两种范式与能力演进四阶段，以及 [5.2](./cold-start.md) 的语义/冷启动基础。本章是 Part 1 双范式的「落地版」——把抽象概念变成具体模型。

在 [1.1](./../part1-introduction/recommender-system-basics.md) 里我们埋下一根线：推荐能从「判别式打分」转向「生成式序列生成」，就像把自然语言当成一种特殊「语言」来理解和产出。本篇前几章沿着判别式三阶段流水线走完了工业实践；现在，是时候回到这根线，看清**生成式范式如何具体演进**。
